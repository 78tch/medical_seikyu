...
|No|項目|内容|
|--|--|--|
|1|自己署名証明書|インターネット上の支払基金のホームページから手順書と一緒にDLできる。IP-VPN上の「電子証明書ダウンロードサイト等」にアクセスするのに必要。電子証明書やオンライン請求システムのセットアッププログラムをダウンロードしたりする。|
|2|電子証明書発行申請|オンライン資格確認システムやオンライン請求システムのサイトにアクセスするのに必要になる。IP-VPN上の「電子証明書ダウンロードサイト等」からDLできるようになる。|
|3|オンライン資格確認システム利用申請|資格確認システムにログインするアカウントの発行。セットアッププログラムは、インターネット上の「医療機関等ONS」からダウンロードする。|
|4|オンライン請求システム利用申請|請求システムにログインするアカウントの発行。セットアッププログラムは、IP-VPN上の「電子証明書ダウンロードサイト等」からDLできる。|
