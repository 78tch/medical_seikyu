...
## 0.オンライン請求システム端末セットアップ
|No|項目|内容|
|--|--|--|
|1|ネットワーク設定|プロキシやDNSを設定する|
|2|『自己署名証明書』を設定|インターネット上の支払基金のホームページからDLする「オンライン請求システムセットアップ手順書（Online_Setup_Manual）」のなかにあり。|
