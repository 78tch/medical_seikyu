...
4. 「電子証明書発行申請」から数日で、簡易書留で「電子証明書取得に関する情報」が送られてくる。これを使って、オンライン用パソコンで「●④電子証明書等ダウンロードサイト」から電子証明書をダウンロードする。ダウンロードしたら、オンライン用パソコンにインストールする。これで、「⑥オンライン資格確認等システム」などに接続できるようになる。  
...
9. 支払基金のホームページから、「オンライン請求」の資料をダウンロードする。
