...
時間がかかるので、前もって済ませておくこと。

|No|項目|内容|
|--|--|--|
|1|電子証明書発行申請|オンライン資格確認システムやオンライン請求システムのサイトにアクセスするのに必要になる。IP-VPN上の「電子証明書ダウンロードサイト等」からDLできるようになる。|
...
|No|項目|内容|
|--|--|--|
|1|手順書・自己署名証明書|インターネット上の支払基金のホームページからDLできる。IP-VPN上の「電子証明書ダウンロードサイト等」にアクセスするのに必要。電子証明書やオンライン請求システムのセットアッププログラムをダウンロードしたりする。|
...
|3|セットアッププログラムをダウンロード|IP-VPN上の「証明書等ダウンロードサイト等」から「OnlineSetup_Iryou_Windows.zip」をDLする。併せてAdobeReaderDCも。|
