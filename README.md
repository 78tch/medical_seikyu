...
4. オンラインシステム用のパソコンを用意し、「IP-VPN閉域網」に接続するためのネットワーク設定をする。指定のユーザーを作成してそれでOSにログインし、プロキシサーバーやDNSサーバーを設定する。設定したプロキシサーバーを有効にしている間は、一般のインターネットにはつながらなくなるので、普段はプロキシを無効にしておき、オンラインシステムを使用する時だけ切り替えてプロキシを有効にするか、もしくはオンラインシステム専用のパソコンを用意するか、どちらかとなる。  
5. 「電子証明書発行申請」から数日で、簡易書留で「電子証明書取得に関する情報」が送られてくる。これを使って、オンライン用パソコンで「●④電子証明書等ダウンロードサイト」から電子証明書をダウンロードする。ダウンロードしたら、オンライン用パソコンにインストールする。これで、「●⑥オンライン資格確認等システム」などに接続できるようになる。  https://hweb.oqs.onshikaku.org/web/  
6. 「オンライン利用申請」から数日で、「①医療機関等向け総合ポータルサイト」から、「マスタアカウント情報」がダウンロードできるようになる。オンライン用パソコンで「⑥オンライン資格確認等システム」に接続し、この情報でログインする。  
7. 「⑥オンライン資格確認等システム」にログインしたら、「管理者アカウント」、「顔認証用アカウント」、「一般利用者アカウント」を作成する。  
...
12. 支払基金のホームページから、「オンライン請求」の資料をダウンロードする。このなかに「自己署名証明書」があるので、インストールする。  https://www.ssk.or.jp/seikyushiharai/online/index.html  
