...
4. 「支払基金のHP」：オンライン請求の資料。そのなかに、「自己署名証明書」も入っている。資料の説明にしたがって、支払基金・国保連合会のIP-VPN閉域網上の「電子証明書等ダウンロードサイト」
5. 「医療機関等ONS」：顔認証連携アプリなど
6. 「カードリーダーのベンダー（富士通Japan）のHP」：カードリーダーソフト
7. 支払基金のIP-VPN閉域網上の「電子証明書ダウンロードサイト等」：認証局の電子証明書、オンライン請求のセットアッププログラム
