...
3. 「オンライン利用申請」から数日で、ポータルサイトから、「マスタアカウント情報」がダウンロードできるようになる。これを使って「⑥オンライン資格確認等システム」にログインする。「電子証明書発行申請」から数日で、簡易書留で「電子証明書取得に関する情報」が送られてくる。これを使って、「④電子証明書等ダウンロードサイト」で電子証明書をダウンロードする。
